...
val inverseOnSurfaceDark = Color(0xFF1A1C20)  // Darkened for better contrast
val inversePrimaryDark = Color(0xFF284777)     // Darkened for better contrast
...
val onLightBackgroundDark = Color(0xFF1A1C20)  // For text on light surfaces in dark mode
val onLightSurfaceDark = Color(0xFF284777)     // For primary-colored text on light surfaces
val onLightContainerDark = Color(0xFF3F2844)   // For accent text on light surfaces
